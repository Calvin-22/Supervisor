...
namespace Supervisor.Dal
{
    ...
    public class Access
    {
        ...
        /// </summary>
        private static readonly string connectionString = "server=localhost; user id=supervisor_admin@; password=D5-66jdlqoa!%okà@d*; database=bdd_supervisor; SslMode=Required;";
        /// <summary>
